...
export default function Navigation({ user, userRole, currencies }: NavigationProps) {
  ...
  return (
    <nav className="sticky top-0 z-50 bg-[#18176b]">
      <div className="flex items-center justify-between px-6 sm:px-8 py-0 min-h-[15px]">
        <div className="flex-shrink-0 w-[120px] h-[120px] bg-transparent">
          <Link href="/" className="block w-full h-full">
            <Image 
              src="/images/skylogo.png" 
              alt="SkySaver Travels Logo" 
              width={120} 
              height={120} 
        ...
        {/* Desktop Navigation */}
        <div className="hidden md:flex gap-4 lg:gap-6 items-center text-sm lg:text-base font-medium flex-shrink-0 ml-auto">
      ...
      <div className="md:hidden flex-shrink-0 ml-4">
          <button
            ...
            className="text-white hover:text-[#cd7e0f] transition p-2"
          >
