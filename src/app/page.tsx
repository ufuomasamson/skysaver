        ...
        <div className="max-w-6xl mx-auto">
          <div className="bg-white rounded-lg shadow-2xl p-4 sm:p-6 lg:p-8">
            <div className="text-center mb-4 sm:mb-6">
              <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold text-[#18176b]">SKYSAVER TRAVELS</h2>
            </div>
            {/* Flight Booking Form */}
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            ...
            <div className="text-center p-6 border rounded-lg">
              ...
              <p className="text-gray-600">Contact booking@skysavertravels.com for check refund status</p>
            </div>
            <div className="text-center p-6 border rounded-lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <p className="mb-2">+13349484877</p>
                              <p>booking@skysavertravels.com</p>
            </div>
            <div>
